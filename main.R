...
datastory_name <- "budget_demand_development"
...
# characters etc.)
# -> Don't put "datastory" at the start or end!
datastory_name_en <- "rising-demand-for-funding-is-becoming-a-challenge"
datastory_name_de <- "steigende-nachfrage-nach-foerdermitteln-wird-zur-herausforderung"
datastory_name_fr <- "la-demande-croissante-de-fonds-devient-un-defi"

# English title and lead of the story (Mandatory, even if no EN version)
title_en <- "Rising demand for funding is becoming a challenge"
lead_en <- "Demand for SNSF funding has been rising for years now. Why is this? Are more researchers applying for funding or are they submitting higher budgets? What consequences is this development having? An evaluation of internal data provides answers."
# German title and lead of the story (Mandatory, even if no DE version)
title_de <- "Steigende Nachfrage nach Fördermitteln wird zur Herausforderung"
lead_de <- "Die Nachfrage nach Mitteln des SNF steigt seit Jahren. Warum? Bewerben sich mehr Forschende um Förderung oder reichen sie höhere Budgets ein? Welche Konsequenzen hat diese Entwicklung? Eine Auswertung interner Daten gibt Antwort."
# French title and lead of the story (Mandatory, even if no FR version)
title_fr <- "La demande croissante de fonds devient un défi"
lead_fr <- "Depuis plusieurs années, les demandes de fonds auprès du FNS augmentent continuellement. Pourquoi cette évolution? Les chercheuses et chercheurs sont-ils plus nombreux à solliciter un financement, ou les budgets soumis sont-ils plus élevés?"
# Contact persons, always (first name + last name)
contact_person <- c("Gabriel Okasa", "Michaela Strinzel")
...
publication_date <- "2024-03-14 04:00:00"
...
doi_url <- "https://doi.org/10.46446/datastory.budget-demand-development"
